...
public class CashDataInit {
    ...
    public void makeBaseCredits() {
        ...
        user1Wallet.credit(150_000, CashLogEventType.충전__무통장입금);
        user1Wallet.credit(100_000, CashLogEventType.충전__무통장입금);
        user1Wallet.credit(50_000, CashLogEventType.충전__무통장입금);

        Wallet user2Wallet = cashFacade.findWalletByHolder(user2Member).get();

        user2Wallet.credit(150_000, CashLogEventType.충전__무통장입금);
    }
}